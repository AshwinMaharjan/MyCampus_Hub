...
$profile_path = "images/{$profile_photo}";
...
// Super Admin Privileges (this page is for super admin only)
$privileges = [
    [
        'icon' => '🛠️',
        'title' => 'Manage Courses & Subjects',
        'description' => 'Create, update, and organize courses and subjects'
    ],
    [
        'icon' => '👥',
        'title' => 'Manage Staff & Students',
        'description' => 'Control user accounts, roles, and permissions'
    ],
    [
        'icon' => '📣',
        'title' => 'Send Notifications',
        'description' => 'Notify users about important updates and events'
    ],
    [
        'icon' => '📅',
        'title' => 'Manage Attendance',
        'description' => 'Oversee and regulate attendance records system-wide'
    ],
    [
        'icon' => '📁',
        'title' => 'Manage Study Materials',
        'description' => 'Monitor and control uploaded academic resources'
    ]
];
