...
if (isset($_POST['register'])) {
    ...
    // Handle profile photo upload WITHOUT renaming (use original filename sanitized)
    if (isset($_FILES['profile_photo']) && $_FILES['profile_photo']['error'] === UPLOAD_ERR_OK) {
        ...
        // If file already exists, overwrite or add a number suffix (optional)
        // For simplicity, we overwrite here.
    ...
    // Check for duplicate email or id_number
    ...
    // Insert user with original filename saved in profile_photo
    ...
    VALUES 
      ('$full_name', '$id_number', '$email', '$password', '$role_id', '$gender', '$dob', '$contact_number', '$address', '$course_id', '$sem_id', '$file_name', '$status')";
