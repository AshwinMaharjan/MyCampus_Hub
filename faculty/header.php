  ...
  <nav class="nav-icons">
    ...
    <div class="profile-dropdown">
      ...
      <div class="dropdown-menu" id="dropdownMenu">
        <a href="faculty_homepage.php"><i class="fas fa-gauge"></i> Dashboard</a>
        <a href="faculty_profile.php?user_id=<?php echo $user_id; ?>"><i class="fas fa-user-circle"></i> My Profile</a>
