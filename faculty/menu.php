...
<li><a href="faculty_homepage.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
<li><a href="my_subjects.php"><i class="fas fa-book-open"></i> My Subjects</a></li>
  ...
  <li><a href="my_students.php"><i class="fas fa-user-graduate"></i> My Students</a></li> -->
  <!-- <li><a href="enter_marks.php"><i class="fas fa-pen-nib"></i> Enter Marks</a></li>
  <li><a href="view_marks.php"><i class="fas fa-file-alt"></i> View Marks</a></li> -->
  <li class="dropdown">
    <a href="#" class="dropdown-toggle"><i class="fas fa-pen-nib"></i> Marks <i class="fas fa-caret-down right"></i></a>
    <ul class="dropdown-content">
      <li><a href="enter_marks.php">Enter Marks</a></li>
      <li><a href="view_marks.php">View Marks</a></li>
    </ul>
  </li>
  <!-- <li><a href="attendance.php"><i class="fas fa-clipboard-check"></i> Mark Attendance</a></li>
  <li><a href="view_attendance.php"><i class="fas fa-eye"></i> View Attendance</a></li> -->
  <li class="dropdown">
    <a href="#" class="dropdown-toggle"><i class="fas fa-calendar-check"></i> Attendance <i class="fas fa-caret-down right"></i></a>
    <ul class="dropdown-content">
  ...
  <!-- <li><a href="student_leave_requests.php"><i class="fas fa-calendar-times"></i> Student Leave Requests</a></li> -->
  <li><a href="staff_leave_requests.php"><i class="fas fa-calendar-times"></i> My Leave Requests</a></li>
  <!-- <li><a href="staff_feedback.php"><i class="fas fa-comments"></i> Staff Feedback</a></li> -->
  <li><a href="study_material.php"><i class="fas fa-folder-open"></i> Study Material</a></li>
  <!-- <li><a href="internship_portal.php"><i class="fas fa-briefcase"></i> Internship/Job Portal</a></li> -->
<li>
  <a href="#" onclick="openLogoutConfirmation(event)">
