...
<li><a href="non_faculty_homepage.php"><i class="fas fa-tachometer-alt"></i> Dashboard</a></li>
<li><a href="view_subjects.php"><i class="fas fa-book-open"></i> View Subjects</a></li>
<li><a href="view_marks.php"><i class="fas fa-file-alt"></i> View Marks</a></li>
<li><a href="view_attendance.php"><i class="fas fa-clipboard-list"></i> View Attendance</a></li>
...
<li><a href="study_material.php"><i class="fas fa-book"></i> Study Material</a></li>
<li>
