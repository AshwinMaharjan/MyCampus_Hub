...
$profile_photo = "../admin/images/uploads/profile_photos/" . $photo_file;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<<<<<<< HEAD
    <a href="non_faculty_homepage.php">
=======
    <a href="homepage.php">
  ...
  <nav class="nav-icons">
    ...
    <div class="profile-dropdown">
      ...
      <div class="dropdown-menu" id="dropdownMenu">
        <a href="non_faculty_homepage.php"><i class="fas fa-gauge"></i> Dashboard</a>
        <a href="non_faculty_profile.php?user_id=<?php echo $user_id; ?>"><i class="fas fa-user-circle"></i> My Profile</a>
        <a href="change_password.php"><i class="fas fa-key"></i> Change Password</a>
        <a href="study_material.php"><i class="fas fa-user-tie"></i> View Assignments</a>
        <a href="view_marks.php"><i class="fas fa-user-graduate"></i> View Marks</a>
